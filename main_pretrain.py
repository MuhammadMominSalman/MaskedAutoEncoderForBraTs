...
def main(args):
    ...
    # f = []
    # l = []
    # for (dirpath, dirnames, filenames) in os.walk("C:/Project/MAE/BraTS2021_TrainingData"):
    #     for x in dirnames:
    #         l.append(x)
    ...
    # df.to_csv('Brats.csv')
    path_to_csv = 'Brats.csv'
    data_loader_train = get_dataloader(path_to_csv = path_to_csv, phase='train', fold = 1, batch_size = args.batch_size,
                                       num_workers = 4, resize = args.resize, resize_in = args.resize_in)
    # define the model
